<?php
	...
	$CMS->unit['product_category'] = new ClassUnitProductCategory();
	class ClassUnitProductCategory{
...
HERE;
		...
		public function ReloadBlock($data){
			...
			if($data){
				...
				$CMS->tpl->data = $data;
				$tmp = $CMS->tpl->Display($CMS->vars['tpl_name']."/block.product_category", false);
				$output = $tmp;
			}else{
				$output = "";
			}
